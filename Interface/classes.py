...
class SearchingColumn(tk.Frame):
    def __init__(self, parent_window, right):
        self = Frame(parent_window, width=300, height=600, bg='red')
        self.grid(row=1, column=right, padx=10, pady=5,sticky="nsew")
        ...
        self.sv = StringVar()
        e = Entry(self, textvariable=self.sv, validatecommand=self.entry_OnChange)#, validate="focusout"
        e.grid()
